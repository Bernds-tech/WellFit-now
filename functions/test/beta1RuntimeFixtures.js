...
async function resetBeta1Collections() {
  const collections = [
    ...
    "userCalendarSettings", "userDailyMissionState", "userDailyStreaks", "userLevels", "xpWallets", "xpLedgerEvents", "ledgerEvents", "auditEvents", "adminActions", "itemDefinitions", "shopItems", "shopPurchaseIntents", "shopPurchaseEvents", "userInventory", "userAvatars", "buddyCareActions", "partners", "partnerOffers", "partnerRedemptions", "partnerOperators", "partnerRedemptionChallenges", "partnerChallengeActivity", "partnerOperationRateLimits", "partnerOperationOutcomes",
