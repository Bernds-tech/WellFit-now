...
async function resetBeta1Collections() {
  const collections = [
    ...
    "accountLifecycleRecords", "userDataExportJobs", "userDataExportChunks", "accountDeletionTombstones",
    ...
    "userCalendarSettings", "userDailyMissionState", "userDailyStreaks", "userLevels", "xpWallets", "xpLedgerEvents", "ledgerEvents", "auditEvents", "adminActions", "itemDefinitions", "shopItems", "shopPurchaseIntents", "shopPurchaseEvents", "userInventory", "userAvatars", "buddyCareActions", "partners", "partnerOffers", "partnerOfferRevisions", "partnerRedemptions", "partnerOperators", "partnerRedemptionChallenges", "partnerChallengeActivity", "partnerOperationRateLimits", "partnerOperationOutcomes",
