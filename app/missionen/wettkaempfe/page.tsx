    ...
    <main className="h-screen w-screen overflow-hidden text-white" style={{ background: `linear-gradient(to bottom right, rgba(0,170,190,${brightness / 100}), rgba(0,80,90,1))` }}>
      <div className="flex h-full">
        ...
        <section className="relative flex h-full flex-1 flex-col overflow-hidden px-7 py-5 pb-0">
          <div className="mb-4 flex items-start justify-between gap-4"><div><h1 className="text-5xl font-extrabold leading-none">Wettkämpfe</h1><p className="mt-1 text-lg text-cyan-100/90">{message}</p></div><div className="flex h-[80px] w-[360px] items-center justify-center overflow-hidden rounded-[18px] border border-yellow-300/40 bg-gradient-to-r from-[#052f36] via-[#0d6872] to-[#ff8a00] shadow-[0_10px_28px_rgba(0,0,0,0.24)]"><div className="text-center"><p className="text-[10px] font-semibold tracking-[0.3em] text-yellow-200">JACKPOT</p><p className="mt-1 text-3xl font-extrabold text-white drop-shadow-[0_3px_10px_rgba(0,0,0,0.45)]">{jackpot.toLocaleString("de-DE")} WFT</p></div></div><div className="flex items-center gap-2"><button className="rounded-full border border-cyan-300/20 bg-[#0a6b78]/20 px-4 py-2 text-sm text-white/90">Synchron</button><button className="rounded-[16px] bg-orange-500 px-5 py-3 text-sm font-bold">Tracker starten</button><div className="rounded-full bg-[#073b44] px-4 py-2 text-sm">Flammi LVL {buddyLevel}</div></div></div>
