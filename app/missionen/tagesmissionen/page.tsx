        ...
        <section className="relative flex h-full flex-1 flex-col overflow-hidden px-7 py-5 pb-0">
          ...
          <div className="grid min-h-0 flex-1 grid-cols-[2.15fr_1fr] gap-5 overflow-hidden pb-20">
            <div className="flex min-h-0 flex-col overflow-hidden">
              <DailySlots missions={dailyMissions} dailySlotIds={dailySlotIds} dragOverSlot={dragOverSlot} setDragOverSlot={setDragOverSlot} assignSlot={assignSlot} clearSlot={clearSlot} selectedMissionId={selectedMissionId} favoriteIds={favoriteIds} recommendedIds={recommendedIds} onSelect={setSelectedMissionId} onToggleFavorite={toggleFavorite} />
              <div className="mt-4 min-h-0 flex-1 overflow-y-auto pr-1">
                <FavoritesStrip missions={dailyMissions} favoriteIds={favoriteIds} selectedMissionId={selectedMissionId} recommendedIds={recommendedIds} onSelect={setSelectedMissionId} onToggleFavorite={toggleFavorite} />
