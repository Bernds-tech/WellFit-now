...
const favoriteCatalog: FavoriteItem[] = [
  { id: "daily-1", title: "Tägliche Schritte", description: "Dein bevorzugtes Tagesziel.", label: "+25 interne Punkte", icon: "👟", href: "/missionen/tagesmissionen", group: "Tagesmissionen" },
  { id: "daily-2", title: "Hampelmänner", description: "Kurze Fitness-Mission mit Kamera-Tracking.", label: "+15 interne Punkte", icon: "🕺", href: "/missionen/tagesmissionen", group: "Tagesmissionen" },
  { id: "weekly-1", title: "Wöchentliche Bewegungsmission", description: "Sammle 50.000 Schritte.", label: "+25 interne Punkte", icon: "👟", href: "/missionen/wochenmissionen", group: "Wochenmissionen" },
  { id: "weekly-2", title: "Wöchentliche Fitnessmission", description: "3× Ganzkörper-Training pro Woche.", label: "+1 Beta-Abzeichen", icon: "🏃", href: "/missionen/wochenmissionen", group: "Wochenmissionen" },
  { id: "adventure-1", title: "Castle", description: "Ritterburg-Abenteuer mit Rätseln.", label: "+300 interne Punkte", icon: "🏰", href: "/missionen/abenteuer", group: "Abenteuer" },
  { id: "adventure-2", title: "Zoo Quest", description: "Tierpark-Abenteuer mit Wissenspunkten.", label: "+180 interne Punkte", icon: "🦁", href: "/missionen/abenteuer", group: "Abenteuer" },
    ...
    <main className="h-screen w-screen overflow-hidden text-white" style={{ background: `linear-gradient(to bottom right, rgba(0,170,190,${brightness / 100}), rgba(0,80,90,1))` }}>
      <div className="flex h-full">
        ...
        <section className="relative flex h-full flex-1 flex-col overflow-hidden px-7 py-5 pb-0">
          <div className="mb-4 flex justify-between"><div><h1 className="text-5xl font-extrabold leading-none">Favoriten</h1><p className="mt-1 text-lg text-cyan-100/90">Hier werden alle gespeicherten Favoriten gesammelt: Missionen, Abenteuer, Challenges, Checkpoints und später Buddy-Hinweise.</p><p className="mt-1 text-sm text-white/60">Alle Belohnungen bleiben interne Beta-Punkte oder Abzeichen. Keine Token, keine NFTs, keine Auszahlung.</p></div><div className="rounded-full bg-[#073b44] px-4 py-2 text-sm">{favorites.length} Favoriten</div></div>
