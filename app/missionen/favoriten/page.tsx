...
type FavoriteItem = {
  ...
  icon: string;
  href: string;
  group: "Tagesmissionen" | "Wochenmissionen" | "Abenteuer" | "Challenge" | "WettkÃ¤mpfe" | "KI-Buddy";
};

const favoriteCatalog: FavoriteItem[] = [
  { id: "daily-1", title: "TÃ¤gliche Schritte", description: "Dein bevorzugtes Tagesziel.", label: "+25", icon: "ðŸ‘Ÿ", href: "/missionen/tagesmissionen", group: "Tagesmissionen" },
  { id: "daily-2", title: "HampelmÃ¤nner", description: "Kurze Fitness-Mission mit Kamera-Tracking.", label: "+15 WFT", icon: "ðŸ•º", href: "/missionen/tagesmissionen", group: "Tagesmissionen" },
  { id: "weekly-1", title: "WÃ¶chentliche Bewegungsmission", description: "Sammle 50.000 Schritte.", label: "+25 WFT", icon: "ðŸ‘Ÿ", href: "/missionen/wochenmissionen", group: "Wochenmissionen" },
  { id: "weekly-2", title: "WÃ¶chentliche Fitnessmission", description: "3Ã— GanzkÃ¶rper-Training pro Woche.", label: "+1 Wochen-NFT", icon: "ðŸƒ", href: "/missionen/wochenmissionen", group: "Wochenmissionen" },
  { id: "adventure-1", title: "Castle", description: "Ritterburg-Abenteuer mit RÃ¤tseln.", label: "+300 WFT", icon: "ðŸ°", href: "/missionen/abenteuer", group: "Abenteuer" },
  { id: "adventure-2", title: "Zoo Quest", description: "Tierpark-Abenteuer mit Wissenspunkten.", label: "+180 WFT", icon: "ðŸ¦", href: "/missionen/abenteuer", group: "Abenteuer" },
  { id: "challenge-3", title: "Mathe-Speed", description: "Rechenaufgaben in 45 Sekunden.", label: "Wissen", icon: "âœ…", href: "/missionen/challenge", group: "Challenge" },
  { id: "competition-1", title: "Rathaus-Checkpoint", description: "Checkpoint mit BÃ¼rgermeister-System.", label: "ðŸ‘‘ BÃ¼rgermeister", icon: "ðŸ§ ", href: "/missionen/wettkaempfe", group: "WettkÃ¤mpfe" },
];

const groups: FavoriteItem["group"][] = ["Tagesmissionen", "Wochenmissionen", "Abenteuer", "Challenge", "WettkÃ¤mpfe", "KI-Buddy"];
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {groupItems.map((item) => (
                      <div key={item.id} className="rounded-[20px] border border-cyan-300/10 bg-[#053841]/90 p-4 shadow-[0_8px_20px_rgba(0,0,0,0.14)]">
                        <div className="mb-3 flex items-start justify-between"><div className="text-3xl">{item.icon}</div><div className="text-xl text-yellow-400">â˜…</div></div>
                        ...
                        <Link href={item.href} className="mt-4 block w-full rounded-lg border border-yellow-400/40 bg-[#0a3d46] px-3 py-2 text-center text-sm font-bold text-white transition hover:bg-[#0e4c57]">Ã–ffnen</Link>
                      </div>
                    ))}
                  </div>
                </div>
