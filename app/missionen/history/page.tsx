...
type HistoryEntry = { id: string; title: string; category: "Tagesmissionen" | "Wochenmissionen" | "Abenteuer" | "Challenge" | "Wettkämpfe" | string; rewardLabel: string; completedAt: string; icon: string; pointsDelta?: number; };
