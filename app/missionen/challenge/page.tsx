...
export default function ChallengePage() {
  ...
  const startRoute = () => { setMessage(`Challenge-Route vorbereitet: ${selectedChallenge.title}. WellFit nutzt Standort als Bewegungskontext, keine Token/NFTs.`); localStorage.setItem("wellfit-active-challenge", JSON.stringify(selectedChallenge.id)); };
