...
export default function LoginForm({ language }: { language: Language }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[450px] rounded-[28px] border border-white/15 bg-cyan-500/20 p-5 shadow-[0_18px_50px_rgba(0,0,0,0.22)] backdrop-blur-md lg:absolute lg:left-1/2 lg:top-[38%] lg:translate-x-[110px]">
      <div className="mb-5">
