...
export default function LoginHero({ language }: { language: Language }) {
  ...
  return (
    <section className="pointer-events-none mx-auto max-w-[1180px] pt-16 lg:absolute lg:left-1/2 lg:top-[17%] lg:z-20 lg:w-[1180px] lg:-translate-x-1/2 lg:pt-0">
      <div className="grid items-start gap-16 lg:grid-cols-[470px_450px] lg:justify-center">
        <div className="pointer-events-auto w-full max-w-[470px] text-left">
