            ...
            <div className={cardClass}>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input className={inputClass} defaultValue="Bernd Guggenberger" />
                </div>
                ...
                <div>
                  ...
                  <input className={inputClass} defaultValue="bernd@wellfit.pro" />
                </div>
                ...
                <div>
                  ...
                  <input className={inputClass} defaultValue="+43 600 1234567" />
                </div>
                ...
                <div>
                  ...
                  <input className={inputClass} defaultValue="14.05.1990" />
                </div>
