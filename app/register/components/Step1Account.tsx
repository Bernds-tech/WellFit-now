...
export default function Step1Account({ language, form, setForm, onNext }: Props) {
  ...
  return (
    <div className="absolute right-16 top-[24%] z-20 flex h-[560px] w-[520px] flex-col overflow-hidden rounded-[34px] border border-white/20 bg-cyan-500/25 px-7 py-5 shadow-[0_18px_50px_rgba(0,0,0,0.24)] backdrop-blur-md">
