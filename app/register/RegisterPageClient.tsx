  ...
  return (
    <main className="relative min-h-screen w-full overflow-y-auto text-white xl:h-screen xl:overflow-hidden">
      ...
      <div className="relative min-h-screen w-full px-5 pb-10 pt-24 sm:px-8 xl:h-full xl:p-0">
        ...
        {step === 1 && <><section className="mx-auto max-w-[1180px] text-center xl:absolute xl:left-1/2 xl:top-16 xl:z-20 xl:w-[1100px] xl:-translate-x-1/2"><div className="mx-auto mb-3 inline-flex rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.22em] text-cyan-100 backdrop-blur-sm sm:text-xs">WellFit Earn Wellness</div><h1 className="text-[2.15rem] font-black leading-[1.05] tracking-tight text-white drop-shadow-[0_10px_28px_rgba(0,0,0,0.22)] sm:text-[2.8rem] lg:text-[3.1rem] xl:whitespace-nowrap">{t.step1Title.replace("\n", " ")}</h1><div className="mx-auto mt-4 flex max-w-[760px] items-center justify-center gap-3 sm:gap-5"><div className="hidden h-[2px] flex-1 rounded-full bg-gradient-to-r from-transparent via-white/35 to-cyan-200/40 sm:block" /><p className="max-w-[520px] text-center text-sm font-semibold leading-snug text-white/90 drop-shadow-[0_4px_14px_rgba(0,0,0,0.18)] sm:text-base">{t.step1Subtitle}</p><div className="hidden h-[2px] flex-1 rounded-full bg-gradient-to-l from-transparent via-white/35 to-cyan-200/40 sm:block" /></div></section><section className="mx-auto mt-8 grid max-w-[1180px] gap-8 xl:mt-0 xl:block"><div className="mx-auto max-w-[560px] text-left xl:absolute xl:left-16 xl:top-[30%]"><div className="mb-7 xl:mb-12"><h2 className="text-2xl font-bold leading-tight sm:text-[2rem]">{t.benefit1Title}</h2><p className="mt-2 text-xl leading-[1.28] sm:text-[1.75rem]">{t.benefit1Text}</p></div><div className="mb-7 xl:mb-12"><h2 className="text-2xl font-bold leading-tight sm:text-[2rem]">{t.benefit2Title}</h2><p className="mt-2 text-xl leading-[1.28] sm:text-[1.75rem]">{t.benefit2Text}</p></div><div><h2 className="text-2xl font-bold leading-tight sm:text-[2rem]">{t.benefit3Title}</h2><p className="mt-2 text-xl leading-[1.28] sm:text-[1.75rem]">{t.benefit3Text}</p></div></div><div className="mx-auto w-full max-w-[520px] xl:absolute xl:right-16 xl:top-[24%]"><Step1Account language={language} form={form} setForm={setForm} onNext={handleStep1} /></div></section><div className="mt-8 text-center text-[0.95rem] xl:absolute xl:bottom-8 xl:right-16">{t.alreadyAccount} <Link href="/" className="font-semibold underline underline-offset-4">{t.login}</Link></div></>}
