...
export default function RegisterPageClient() {
  ...
  return (
    <main className="relative min-h-screen w-full overflow-y-auto text-white xl:h-screen xl:overflow-hidden">
      ...
      <div className="relative min-h-screen w-full px-5 pb-10 pt-24 sm:px-8 xl:h-full xl:p-0">
        ...
        {step === 1 && <><section className="mx-auto max-w-[900px] scale-[0.85] origin-top text-center xl:absolute xl:left-1/2 xl:top-14 xl:z-20 xl:w-[900px] xl:-translate-x-1/2"><div className="mx-auto mb-2 inline-flex rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[9px] font-black uppercase tracking-[0.2em] text-cyan-100 backdrop-blur-sm sm:text-[10px]">WellFit Earn Wellness</div><h1 className="text-[1.65rem] font-black leading-[1.05] tracking-tight text-white drop-shadow-[0_10px_28px_rgba(0,0,0,0.22)] sm:text-[2.15rem] lg:text-[2.35rem] xl:whitespace-nowrap">{t.step1Title.replace("\n", " ")}</h1><div className="mx-auto mt-3 flex max-w-[620px] items-center justify-center gap-3 sm:gap-4"><div className="hidden h-[2px] flex-1 rounded-full bg-gradient-to-r from-transparent via-white/35 to-cyan-200/40 sm:block" /><p className="max-w-[430px] text-center text-xs font-semibold leading-snug text-white/90 drop-shadow-[0_4px_14px_rgba(0,0,0,0.18)] sm:text-sm">{t.step1Subtitle}</p><div className="hidden h-[2px] flex-1 rounded-full bg-gradient-to-l from-transparent via-white/35 to-cyan-200/40 sm:block" /></div></section><section className="mx-auto mt-4 grid max-w-[930px] gap-5 xl:mt-0 xl:block"><div className="mx-auto max-w-[420px] scale-[0.85] origin-top-left text-left xl:absolute xl:left-16 xl:top-[30%]"><div className="mb-5 xl:mb-7"><h2 className="text-xl font-bold leading-tight sm:text-[1.5rem]">{t.benefit1Title}</h2><p className="mt-1.5 text-base leading-[1.28] sm:text-[1.3rem]">{t.benefit1Text}</p></div><div className="mb-5 xl:mb-7"><h2 className="text-xl font-bold leading-tight sm:text-[1.5rem]">{t.benefit2Title}</h2><p className="mt-1.5 text-base leading-[1.28] sm:text-[1.3rem]">{t.benefit2Text}</p></div><div><h2 className="text-xl font-bold leading-tight sm:text-[1.5rem]">{t.benefit3Title}</h2><p className="mt-1.5 text-base leading-[1.28] sm:text-[1.3rem]">{t.benefit3Text}</p></div></div><div className="mx-auto w-full max-w-[410px] xl:absolute xl:right-20 xl:top-[25%]"><Step1Account language={language} form={form} setForm={setForm} onNext={handleStep1} compact /></div></section><div className="mt-5 text-center text-[0.82rem] xl:absolute xl:bottom-8 xl:right-24">{t.alreadyAccount} <Link href="/" className="font-semibold underline underline-offset-4">{t.login}</Link></div></>}
