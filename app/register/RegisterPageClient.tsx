  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden text-white">
      ...
      <div className="relative h-full w-full">
        ...
        {step === 1 && <><div className="absolute left-16 top-[30%] max-w-[560px] text-left"><div className="mb-12"><h2 className="text-[2rem] font-bold leading-tight">{t.benefit1Title}</h2><p className="mt-2 text-[1.75rem] leading-[1.28]">{t.benefit1Text}</p></div><div className="mb-12"><h2 className="text-[2rem] font-bold leading-tight">{t.benefit2Title}</h2><p className="mt-2 text-[1.75rem] leading-[1.28]">{t.benefit2Text}</p></div><div><h2 className="text-[2rem] font-bold leading-tight">{t.benefit3Title}</h2><p className="mt-2 text-[1.75rem] leading-[1.28]">{t.benefit3Text}</p></div></div><Step1Account language={language} form={form} setForm={setForm} onNext={handleStep1} /><div className="absolute bottom-8 right-16 text-center text-[0.95rem]">{t.alreadyAccount} <Link href="/" className="font-semibold underline underline-offset-4">{t.login}</Link></div></>}
