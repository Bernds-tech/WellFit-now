...
- Selected local action: `WFN-PARTNER-CATALOG-GOVERNANCE-BASELINE`
1. separate offer creation from controlled lifecycle transitions;
2. prevent inventory reset or incompatible term rewrites after claims exist;
3. record immutable revisions and prove forbidden/concurrent transitions;
