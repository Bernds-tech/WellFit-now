...
## Rules
- WFN-LOOP-015 / WFN-PARTNER-CATALOG-REVISION-READ-BASELINE is OPEN until explicit admin authorization, offer isolation and cursor bounds pass exact-head CI.
