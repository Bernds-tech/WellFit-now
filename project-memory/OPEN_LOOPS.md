...
- Status: OPEN
- Updated: 2026-09-05
- Gap: successive owner reviews found the public Site model too large/clipped, then still visually trapped in a separate viewport, missing CTA emotion and hiding the table too long. The repository bridge now uses reduced scale and safe margins, preserves Rudi's content-world position during scroll before an autonomous climb/run catch-up, restores distance-based CTA head/spine attention and stages a larger table as the second scene. Browser/device visual acceptance remains open. The current 24-bone Meshy rig includes head, spine, shoulders, arms, forearms, hands, hips, legs, feet and toes, but no individual finger joints or facial morph targets.
