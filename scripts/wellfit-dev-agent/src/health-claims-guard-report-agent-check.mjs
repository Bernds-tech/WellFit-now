...
const ENTRY_ID = 'health-claims-guard-report-agent';
const REGISTER_PATH = "project-register/health-claims-guard-report-agent.json";
const DOC_PATH = "docs/architecture/WELLFIT_HEALTH_CLAIMS_GUARD_REPORT_AGENT.md";
const SCRIPT_PATH = "scripts/wellfit-dev-agent/src/health-claims-guard-report-agent-check.mjs";
...
console.log(`Agent: Health Claims Guard Report Agent`);
...
console.log("HEALTH_CLAIMS_GUARD_REPORT_AGENT_READY=true");
