...
const ENTRY_ID = 'location-safety-guard-report-agent';
const REGISTER_PATH = "project-register/location-safety-guard-report-agent.json";
const DOC_PATH = "docs/architecture/WELLFIT_LOCATION_SAFETY_GUARD_REPORT_AGENT.md";
const SCRIPT_PATH = "scripts/wellfit-dev-agent/src/location-safety-guard-report-agent-check.mjs";
...
console.log(`Agent: Location Safety Guard Report Agent`);
...
console.log("LOCATION_SAFETY_GUARD_REPORT_AGENT_READY=true");
