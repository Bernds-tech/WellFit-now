...
function main() {
  ...
  assertCondition(checks, "Approved agent build runner merge gate reported safely", approvedAgentBuildRunnerMergeGateReady, approvedAgentBuildRunnerMergeGateReady ? "REPORT_ONLY_MERGE_GATE, maxAgentsPerRun=1, missing checks block merge, MERGE_READY=false" : "not found or unsafe output");
