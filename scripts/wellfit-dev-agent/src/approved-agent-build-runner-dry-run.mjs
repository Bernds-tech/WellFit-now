...
const ALLOWED_POLICY_ACTIVATION_STATES = new Set(["report_only", "single_agent_docs_execution"]);
...
function main() {
  ...
  const docsExecutionActivated = policy.activationState === "single_agent_docs_execution";
