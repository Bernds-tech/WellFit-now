...
function chooseTask(queue, riskClassifier, definitionOfDone, currentState, workMap) {
  ...
  if (!selected) return { selected: null, reason: "No non-blocked low/medium risk task with a valid definition-of-done key is available." };
...
function main() {
  ...
  const choice = chooseTask(queue, riskClassifier, definitionOfDone, currentState, workMap);
