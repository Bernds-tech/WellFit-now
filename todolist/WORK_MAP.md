...
- `project-register/adaptive-user-insights.json`, `docs/architecture/WELLFIT_ADAPTIVE_USER_INSIGHT_AGENT.md` und `scripts/wellfit-dev-agent/src/adaptive-user-insight-check.mjs` erweitern die bestehende Governance nur planning-only: Future Agents duerfen daraus ausschliesslich aggregierte, anonymisierte Insight-Zusammenfassungen oberhalb Mindest-Schwellen nutzen und keine Live-Tracker, Runtime-Personalisierung oder geschuetzten Datenbereiche aktivieren.
...
| Agents / Quality Gate / Governance | `AGENTS.md`, `agents/`, `scripts/wellfit-dev-agent/src/`, `project-register/agent-workflows.json`, `project-register/agent-task-queue.json`, `project-register/adaptive-user-insights.json`, `todolist/TODO_INDEX.md`, `todolist/NEXT_ACTIONS.md`, `todolist/TODO_CONSOLIDATION.md`, `todolist/MASTER_PROMPT_FOR_AI.md`, `todolist/LOCAL_AGENT_RUN_INSTRUCTIONS.md`, `docs/architecture/STUFE_4_GOVERNANCE_BIS_G_ABSCHLUSS.md`, `docs/architecture/WELLFIT_ADAPTIVE_USER_INSIGHT_AGENT.md` | Keine zweite Agent-Governance einfuehren. Neue Regeln nur minimal und an fuehrenden Dateien verlinkt ergaenzen; Adaptive-Insight-Empfehlungen bleiben planning-only und menschlich pruefpflichtig fuer High-/Critical- oder geschuetzte Bereiche. |
