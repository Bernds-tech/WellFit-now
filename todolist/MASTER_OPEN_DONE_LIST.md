...
- [x] Dynamische Aussch√ºttungslogik dokumentiert: hohe Reserve = mehr Aussch√ºttung, niedrige Reserve = weniger Aussch√ºttung.
...
- [x] Mission Panel zeigt Reward Preview: bereit / Review n√∂tig / blockiert.
...
- Dashboard zeigt Reserve, Aussch√ºttungsfaktor und Goodie-Preisfaktor.
...
- Reserve-/Aussch√ºttungslogik wird ueber RewardPreview beruecksichtigt.
- MissionDetails zeigt Preview-Status, interne Punkte, Reserve-Aussch√ºttung und Beta-Hinweise.
...
- Keine Token, NFTs, Wallets, K‰ufe oder Auszahlungen.

## Wichtig

Dieser Block ist der n‰chste Schritt weg von reiner Client-Logik. Die finale Reward-/Spend-Autoritaet bleibt weiterhin ein sp‰terer Server-/Ledger-/Firestore-Rules-Ausbau.
