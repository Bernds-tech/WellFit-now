...
1. `project-register/wellfit-beta1-canonical-truth.json`
2. `docs/architecture/WELLFIT_BETA1_CANONICAL_TRUTH.md`
3. `todolist/CODEX_CONTEXT_WELLFIT_BETA1.md`

## Kurzkontext fuer Codex/Agenten
...
- Keine Runtime- oder Produktlogik nur auf Basis dieses Kontextdokuments aktivieren.
- Keine Firebase Rules/Functions/DB-Migrationen in diesem Canonical-Truth-Kontexttask.
- Keine Reward-/Ledger-/Anti-Cheat-Autoritaet clientseitig finalisieren.
- Keine Token-/Wallet-/NFT-/Payment-/Exchange-Features aktivieren.

## Ziel dieser Datei

Schneller, einheitlicher Einstiegs-Kontext fuer Agenten/Codex, damit die Beta-1-Wahrheit in sicheren Dokumentations- und Register-Aenderungen konsistent angewendet wird.
