...
- PR Post-Creation Mergeability Guard am 2026-05-16 auf Branch `task/pr-post-creation-guard`: docs/register/script-only Governance, die kuenftige Agenten nach PR-Erstellung zu PR-URL/-Nummer, Nicht-`main`-Branch, Mergeability, Required Checks, Changed Files, Protected Paths, Auto-Merge-/Auto-Repair-/PR-Review-Report, Task-/Work-Log-Evidence und Next Action verpflichtet. Der Guard bleibt report-only/policy-only: kein Auto-Merge, keine Self-Approval, kein Deployment, keine unbeschraenkte Auto-Reparatur und keine Runtime-/Protected-/Unity-/PR-#13-Aenderung.
...
- Continuity & Dependency Sentinel wurde am 2026-05-16 als report-only Governance ergaenzt: `project-register/continuity-dependency-map.json`, `docs/architecture/WELLFIT_CONTINUITY_DEPENDENCY_SENTINEL.md` und `scripts/wellfit-dev-agent/src/continuity-dependency-check.mjs` bewahren offene Punkte, Follow-ups, Review-/Blocker-Dependencies, Required-Next-Files und naechste Agenten-Handoffs; keine Runtime-/Produktdateien, Unity/PR #13, Auto-Merge, Auto-Repair, Approval oder Deployment wurden aktiviert.
- Agent Extension vs New Agent Proposal Policy wurde am 2026-05-16 als report-only Governance ergaenzt: `project-register/agent-extension-policy.json`, `docs/architecture/WELLFIT_AGENT_EXTENSION_POLICY.md` und `scripts/wellfit-dev-agent/src/agent-extension-policy-check.mjs` entscheiden, ob bestehende Agenten sicher erweitert werden duerfen oder ob neue Agentnamen/Register/Workflow-Familien/Protected-Scope zuerst als Proposal mit Human Review dokumentiert werden muessen; keine Agenten, Runtime-/Produktdateien, Auto-Merge, Auto-Repair, Approval oder Deployment werden automatisch erstellt oder aktiviert.
- Website Agent Framework wurde am 2026-05-16 docs/register/script-only ergaenzt: `project-register/website-agents.json`, `project-register/website-readiness.json`, `docs/architecture/WELLFIT_WEBSITE_AGENT_FRAMEWORK.md` und `scripts/wellfit-dev-agent/src/website-agent-framework-check.mjs` definieren report-only Website-Completion-, Route-/Link-, Mobile/PWA-, Visual-, Content-, Trust/Compliance-, Conversion-, SEO-, Waitlist-, Investor-, Analytics/Experiment- und Self-Improving-Grenzen; keine Runtime-Seiten, Legal-Texte, Auto-Merge, Auto-Repair, Approval, Deployment, Unity oder geschuetzte Produktlogik wurden dadurch freigegeben.
- Website Agent Backlog wurde am 2026-05-16 docs/register/script-only ergaenzt: `project-register/website-agent-backlog.json`, `docs/architecture/WELLFIT_WEBSITE_AGENT_BACKLOG.md` und `scripts/wellfit-dev-agent/src/website-agent-backlog-check.mjs` speichern kuenftige Website-Findings, Review-required-Punkte, Mobile/PWA-Evidence-Luecken, Blocker und naechste sichere Tasks maschinenlesbar; der Check ist report-only im Quality Gate verankert und erlaubt keine Runtime-/Legal-/Protected-Topic-Aenderungen.
