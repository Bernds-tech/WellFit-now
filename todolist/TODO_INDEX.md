...
| `docs/beta/BETA1_EMULATOR_VERIFICATION.md` | aktiv / Verification-Runbook | Runbook fuer Beta-1 Emulator-Verifikation, CI-Workflow, bekannte Blocker (`Firestore Emulator JAR 403 Forbidden`, `ECONNREFUSED 127.0.0.1:8080`) und No-Secrets/No-Deploy/`demo-no-project`-Grenzen | `.github/workflows/beta1-emulator-tests.yml`, `docs/beta/prompts/CODEX_PROMPT_BETA1_EMULATOR_CI_VERIFICATION.md`, `project-register/agent-work-log.json` | Nach erstem GitHub-Actions-Lauf echte gruen/blockiert Logs nachtragen; keine Fake-Erfolge melden |
