...
| `docs/architecture/WELLFIT_ADAPTIVE_USER_INSIGHT_AGENT.md` | aktiv / Planning-only Governance | erklaert privacy-sichere adaptive User-Insight- und Personalization-Agent-Regeln fuer aggregierte Signale, Mission/Buddy/Difficulty-Empfehlungen, Human-Approval-Gates und Koexistenz mit PR #60 Research & Recommendation Governance | `project-register/adaptive-user-insights.json`, `project-register/user-feedback.json`, `project-register/feedback-analytics-loop.json` | keine Live-Tracker, Runtime-Personalisierung oder Rohdaten-Exporte aktivieren |
...
| `project-register/adaptive-user-insights.json` | aktiv / maschinenlesbares Register | Planning-only Adaptive-User-Insight-Governance mit erlaubten Aggregat-Signalen, verbotenen Roh-/Sensitivfeldern, Personalisierungsdimensionen, Mindest-Schwellen, Explainability, Human-Review-Triggern, PR #60 Koexistenzreferenz und leerem Entries-Array | `docs/architecture/WELLFIT_ADAPTIVE_USER_INSIGHT_AGENT.md`, `project-register/agent-workflows.json` | nur aggregierte anonymisierte Summaries; keine Live-Tracker, Rohdaten, Health/Child/Location/Camera/Biometric/Payment/Token/Wallet-Daten |
...
| `scripts/wellfit-dev-agent/src/adaptive-user-insight-check.mjs` | aktiv / Code | validiert Adaptive-User-Insight-Register, planning-only Status, erlaubte Aggregat-Signale, verbotene sensitive Felder, Mindest-Schwellen, Explainability, High-/Critical-Human-Review-Trigger und Quality-Gate-Koexistenz mit research-recommendation-check | `project-register/adaptive-user-insights.json` | direkt und im Quality Gate ausfuehren; aktiviert kein Tracking |
...
| `scripts/wellfit-dev-agent/src/quality-gate.mjs` | aktiv / Code | fuehrt Kontrollkette inklusive Drift-/Gap-Detektoren, Agent-Governance-Control-Check, Research-Recommendation-Check, Adaptive-User-Insight-Check, Firestore-Economy-Rules-Check, Next-Task-Picker und TODO-Status-Sync aus und entscheidet PASS/FAIL | Agent-Code | keine KI-Prompt-Pflicht |
