...
| `docs/architecture/MISSION_DRAFT_EMULATOR_TEST_PLAN.md` | aktiv / Testplan | Mission-Draft Emulator-Testplan inkl. lokaler Emulator-Voraussetzungen und Authority-Grenzen | Mission/QA | mit Coder 2 abgleichen; keine MissionDraft-Reward-/Completion-Autoritaet aktivieren |
