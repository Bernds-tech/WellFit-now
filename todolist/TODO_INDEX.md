...
| `scripts/wellfit-dev-agent/src/quality-gate.mjs` | aktiv / Code | fuehrt Kontrollkette inklusive Drift-/Gap-Detektoren, Agent-Governance-Control-Check, Research-Recommendation-Check, Adaptive-User-Insight-Check, Batch-Autopilot-Dry-Run, Auto-Merge-Eligibility-Check, Auto-Repair-Decision-Check, Firestore-Economy-Rules-Check, Next-Task-Picker und TODO-Status-Sync aus und entscheidet PASS/FAIL | Agent-Code | keine KI-Prompt-Pflicht |
