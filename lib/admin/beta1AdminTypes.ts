...
export type AgentCenterAutopilotSnapshot = {
  ...
  agentCenterCounts?: Record<string, number>;
  safetyDossierStatus?: Record<string, unknown>;
  resetSafetyStatus?: Record<string, unknown>;
  openAgentDossiers?: Array<Record<string, unknown>>;
  approvedAgentDossiers?: Array<Record<string, unknown>>;
  taskProposalCounts?: AgentTaskProposalStatusCounts;
  workerQueueCounts?: Record<string, number>;
  runnerJobCounts?: Record<string, number>;
  pickupContractCounts?: Record<string, number>;
  implementationPlanCounts?: Record<string, number>;
  ...
  noTokenPaymentBlockchain?: boolean;
  sanitized?: boolean;
  screenshotsNoLongerNeededReason?: string;
};
