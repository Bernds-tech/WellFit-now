...
export default function WeeklyMissionCatalogAdminCard() {
  ...
  return (
    <Beta1SectionCard
      ...
      description="Admin-only Abgleich der drei kanonischen Beta-1-Hauptmissionen. Jeder Nutzer kann eine Mission höchstens einmal pro Wien-Woche abschließen."
    >
      <div className="mb-3 flex flex-wrap gap-2">
        ...
        <Beta1StatusBadge tone="neutral">Wien-Wochengrenze</Beta1StatusBadge>
      ...
      {guardState !== "allowed" ? (
        ...
        <>
          <div className="rounded-lg border border-white/10 bg-black/20 p-3 text-xs leading-relaxed text-white/75">
            ...
            <p><strong>Policy:</strong> `once-per-mission-per-vienna-week`</p>
          </div>
