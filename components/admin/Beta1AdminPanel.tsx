  ...
  return (
    <section className="space-y-4 text-sm text-slate-100">
      ...
      <section className="rounded border border-white/20 bg-slate-900/50 p-3 text-xs text-white/85">
        ...
        <AdminForm title="Create PR / Metadata" fields={["jobId"]} feedback={feedback["github-runner-pr"]} onSubmit={async (fd)=>{await run("github-runner-pr",()=>beta1AdminClient.createAgentGithubPullRequest({jobId: normalize(fd.get("jobId"))}));}} />
